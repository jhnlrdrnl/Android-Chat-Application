...
public class ChatActivity extends AppCompatActivity implements TextWatcher {
    ...
    private final String SERVER_PATH = "https://192.168.1.3/3000; /* replace it with your own SERVER_PATH */
    ...
    private void initializeView() {
        ...
        pickImgBtn = findViewById(R.id.selectImageButton);
        recyclerView = findViewById(R.id.recyclerView);
        messageAdapter = new MessageAdapter(this, getLayoutInflater());
